...
urlpatterns = [
    ...
    # <表单页面路由开始
    path('site_manage/<int:site_id>', views.site_manage, name='site_manage'),
    ...
    path('game_list/<int:site_id>', views.game_list, name='game_list'),
    path('game_list_ok/<int:site_id>', views.game_list_checked, name='game_list_checked'),
    path('delete/<int:game_id>', views.del_game, name='del_game'),
    path('addgame/<int:site_id>', views.add_game, name='add_game'),
    ...
    path("generate_game/<int:game_id>/<int:site_id>", views.generate_game_html, name="generate_game"),  # 生成单个游戏页静态html文件
    ...
    path("generate_allpage_html/<int:site_id>", views.generate_allpage_html, name="generate_allpage_html"),  # 生成所有游戏页静态html文件
    # >静态页路由结束
