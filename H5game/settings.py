"""
Django settings for H5game project.
...
SECRET_KEY = 'django-insecure-y01ew9^l%1vvpnh*hue$a6120rq_6ub+o7*-wb+u9tz)or=eji'
...
WSGI_APPLICATION = 'H5game.wsgi.application'
